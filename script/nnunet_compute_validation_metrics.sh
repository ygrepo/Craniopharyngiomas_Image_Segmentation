...
OUT_CASE_FN="${OUTP}/${DATASET_ID}_${TR}__${PLANS_ID}__${CFG}_fold${FOLD}_validation_metrics_cases.csv"
OUT_SUMMARY_FN="${OUTP}/${DATASET_ID}_${TR}__${PLANS_ID}__${CFG}_fold${FOLD}_validation_metrics_summary.csv"
OUT_MICRO_FN="${OUTP}/${DATASET_ID}_${TR}__${PLANS_ID}__${CFG}_fold${FOLD}_validation_metrics_micro.csv"
OUT_COUNTS_FN="${OUTP}/${DATASET_ID}_${TR}__${PLANS_ID}__${CFG}_fold${FOLD}_validation_metrics_counts.csv"
