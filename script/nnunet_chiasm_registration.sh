#!/bin/bash
#   nnunet_chiasm_registration.sh    —  Run nnU-Net registration.
#SBATCH --job-name=nnunet_chiasm_registration
#SBATCH --output=logs/nnunet_chiasm_registration_%A_%a.out
#SBATCH --error=logs/nnunet_chiasm_registration_%A_%a.err
...
MAIN="src/nnunet_chiasm_registration.py"

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_FILE="${LOG_DIR}/nnunet_chiasm_registration_${TIMESTAMP}.log"
